...
// ─────────────────────────────────────────────────────────────────────────────
// "Cryptocurrencies" has been REMOVED from navigation.
// Stocks + Crypto history are now unified inside Trading History.
// ─────────────────────────────────────────────────────────────────────────────
const navigation = [
            ...
            {!isCollapsed ? (
              <div className="flex items-center space-x-3">
                {user?.profileImageUrl ? (
                  <img
                    src={user.profileImageUrl} alt="Profile"
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 opacity-80" data-testid="text-user-plan">
                    Premium Plan
                  </p>
                </div>
              </div>
            ...
            <div className="h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
              <ul className="space-y-2">
                {navigation.map((item) => {
                  const isActive =
                    location === item.href ||
                    // Keep "Trading History" highlighted if user visits old /cryptocurrencies URL
